...
/// Utility alias for strong_type<bool>
template <size_t Tag>
using strong_bool = strong_type<bool, Tag>;


/// Utility alias for strong_type<bool> that allow implicit conversion to bool
/// This enables "native" logical operators (&& and ||) between weak bools
template <size_t Tag>
using weak_bool = strong_type<bool, Tag, options::allow_implicit_conversion_to_underlying_type>;
